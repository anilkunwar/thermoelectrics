# Machine learning assisted design of thermoelectrics
...
Data visualization for Model A (MA) training using PyTorch (Interface for User Uploaded Data):
...
Web app interface for Seebeck Coefficient Prediction:
...
# Visualization of the Distribution of Composition and Temperature dependent Seebeck Cofficient (via Attentive Model aided Discovery Learning) 
...
[![machinelearningthermoelectricity](https://img.shields.io/badge/alphanumericgnnmodel-streamlit-red)](https://alphanumeric-vaepredictor-seebeckcoefficient.streamlit.app/) 
