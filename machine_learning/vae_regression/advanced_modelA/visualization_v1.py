...
def plot_radar(data, labels, title, max_samples=10, alpha=0.3, linewidth=2, fontsize=16, legend_pos='upper right'):
...
def plot_training_history_matplotlib(history_df, title, filename, linewidth=2.5, fontsize=12, train_color='#1f77b4', val_color='#ff7f0e', tick_fontsize=10):
    try:
    ...
    ax1.tick_params(axis='both', which='major', labelsize=tick_fontsize, width=1.5, length=6)
    ...
    ax2.tick_params(axis='both', which='major', labelsize=tick_fontsize, width=1.5, length=6)
...
def plot_training_history_plotly(history_df, title, train_color='#1f77b4', val_color='#ff7f0e', linewidth=3, label_fontsize=12, tick_fontsize=10):
    fig = go.Figure()
    ...
    fig.update_layout(
        ...
        xaxis_title='Epoch',
        yaxis_title='Value',
        xaxis=dict(showgrid=True, gridcolor='rgba(0,0,0,0.1)', zeroline=False, showline=True, linewidth=2, linecolor='black', tickfont=dict(size=tick_fontsize)),
        yaxis=dict(showgrid=True, gridcolor='rgba(0,0,0,0.1)', zeroline=False, showline=True, linewidth=2, linecolor='black', tickfont=dict(size=tick_fontsize)),
        plot_bgcolor='white',
        paper_bgcolor='white',
...
def plot_latent_box(z_train, box_linewidth=1, label_fontsize=12):
    fig = go.Figure()
    ...
    fig.update_layout(
        ...
        yaxis_title='Value',
        xaxis=dict(showgrid=True, gridcolor='rgba(0,0,0,0.1)', zeroline=False, showline=True, linewidth=2, linecolor='black', tickfont=dict(size=label_fontsize)),
        yaxis=dict(showgrid=True, gridcolor='rgba(0,0,0,0.1)', zeroline=False, showline=True, linewidth=2, linecolor='black', tickfont=dict(size=label_fontsize)),
        plot_bgcolor='white',
        paper_bgcolor='white',
...
if dataset_file is not None:
    ...
    fig_box = plot_latent_box(z_train, box_linewidth=box_linewidth, label_fontsize=box_label_fontsize)
    ...
    fig.update_layout(
        ...
        xaxis=dict(showgrid=True, gridcolor='rgba(0,0,0,0.1)', zeroline=False, showline=True, linewidth=2, linecolor='black', tickfont=dict(size=scatter_label_fontsize)),
        yaxis=dict(showgrid=True, gridcolor='rgba(0,0,0,0.1)', zeroline=False, showline=True, linewidth=2, linecolor='black', tickfont=dict(size=scatter_label_fontsize)),
        plot_bgcolor='white',
        paper_bgcolor='white',
    ...
    cbar1.ax.tick_params(labelsize=scatter_label_fontsize - 2, width=1.5, length=6)
    ax1.grid(True, linestyle='--', alpha=0.5)
    ax1.spines['top'].set_visible(False)
    ax1.spines['right'].set_visible(False)
    ax1.spines['left'].set_linewidth(1.5)
    ax1.spines['bottom'].set_linewidth(1.5)
    ax1.tick_params(axis='both', which='major', labelsize=scatter_label_fontsize - 2, width=1.5, length=6)
    ...
    ax2.spines['left'].set_linewidth(1.5)
    ax2.spines['bottom'].set_linewidth(1.5)
    ax2.tick_params(axis='both', which='major', labelsize=scatter_label_fontsize - 2, width=1.5, length=6)
    ...
    fig_radar = plot_radar(radar_data, radar_labels, "8D Latent Space Radar Plot", max_samples=max_samples, alpha=radar_alpha, linewidth=radar_linewidth, fontsize=radar_fontsize, legend_pos=radar_legend_pos)
    ...
    fig_parallel.update_layout(
        title=dict(text='8D Latent Space Parallel Coordinates', x=0.5, xanchor='center', font=dict(size=16, family='Arial')),
...
if vae_history_file is not None:
    ...
    fig_vae = plot_training_history_matplotlib(vae_history_df, "VAE", os.path.join(script_dir, 'vae_history_matplotlib.pdf'), 
                                              ...
                                              train_color=train_color, val_color=val_color, tick_fontsize=history_tick_fontsize)
    st.pyplot(fig_vae)
    ...
    fig_vae_plotly = plot_training_history_plotly(vae_history_df, "VAE", train_color=train_color, val_color=val_color, 
                                                 ...
                                                 tick_fontsize=history_tick_fontsize)
