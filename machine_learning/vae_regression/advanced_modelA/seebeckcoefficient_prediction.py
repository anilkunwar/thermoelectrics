...
try:
    ...
    st.error("Required files (vae_model.pt, regressor_model.pt, scaler.pkl, y_scaler.pkl) not found in the script directory.")
    st.stop()
...
st.title("Thermoelectric Material Seebeck Coefficient Prediction (Model A Trained using PyTorch)")
