...
**Date and Time**: 04:35 PM CEST, Tuesday, August 19, 2025
""")
...
if st.button("Generate Ternary Diagram"):
    if len(st.session_state.selected_elements) > 0:
        ...
        if total == 0:
            ...
            st.write(f"**Material Type Used**: {st.session_state.sign_bias} ({'Manual' if st.session_state.use_manual_material_type else 'SciBERT Suggestion'})")
